...
?>
        ...
        <div class="container">
            <div class="nutrihero__wrap flexi">
                <div class="nutrihero__main">
                    ...
                    <ul class="nutrihero__list">
                        ...
                        <li>научитесь восстанавливать и поддерживать здоровье <br>через <b>коррекцию питания</b> и <b>образа
                                жизни</b></li>
                        <li>получите сертификат установленного образца РФ,<br>а также два международных сертификата с
                            правом консультирования в сфере нутрициологии
                        </li>
                    </ul>
                    ...
                    <div class="nutrihero__treeblock flexi">
                        ...
                        <p>Единственная в России образовательная программа, реализуемая при поддержке <b>Федерального
                                исследовательского центра питания, биотехнологий и безопасности пищи</b></p>
                    </div>
                </div><!-- //nutrihero__main -->
            ...
            <div class="nutrihero__bottom">
                <div class="nutrihero__feat">
                    ...
                    <div class="nutrihero__feattxt">Никакой восточной магии и шаманства. Мы даем знания, имеющие под
                        собой твердую доказательную базу.
                    </div>
                </div>
                <div class="nutrihero__feat">
                    <div class="nutrihero__picwrap">
                    ...
                    <div class="nutrihero__feattxt">Курс создан для <b>обучения с нуля</b>. Чтобы усвоить материал, <b>необязательно</b>
                        иметь медицинское образование или даже начальные знания о нутрициологии.
                    </div>
                </div>
                <div class="nutrihero__feat">
                    <div class="nutrihero__picwrap">
                    ...
                    <div class="nutrihero__feattxt">и научитесь добиваться <b>долгосрочных изменений</b> в сфере
                        здоровья для себя и&nbsp;своих&nbsp;близких
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="programfromlead mb-0 programfromlead--nutri">
        <div class="container">
            ...
            get_template_part('inc/leadform', null,
                ['buttonTxt' => 'Получить программу', 'formClassName' => 'nutriformbox']); ?>
        </div>
            ...
            <div class="nutri4__wrap flexi">
                ...
                <div class="nutri4__right">
                    <div class="nutri4__tags">
                        ...
                        <div class="nutri4__item js-slide-interval">Я в постоянном стрессе и поэтому переедаю</div>
            ...
            <div class="nutri5__grid">
                <div class="nutri5__item js-slide-bot">
                    ...
                    <div class="nutri5__itemtxt">
                        В 2022 году по данным Института <br>труда спрос на специалистов <br>по питанию <b>вырос в 1,5
                            раза</b>
                    </div>
                </div>
                <div class="nutri5__item js-slide-bot">
                    ...
                    <div class="nutri5__itemtxt">
                        Число людей, заинтересованных <br>в здоровом образе жизни <b>выросло <br>в 3 раза</b> за
    ...
    <section class="guideform guideform--nutri mb-0">
        <div class="container">
            ...
            <?php
            get_template_part('inc/leadform', null,
                ['buttonTxt' => 'Получить гайд', 'formClassName' => 'nutriformbox']); ?>
        </div>
    </section><!-- //guideform -->
        ...
        <div class="container">
            ...
            <div class="iphone__wrap flexi">
                ...
                <div class="iphone__grid">
                    ...
                    <div class="iphone__prop">
                        <img data-src="<?= $pics; ?>/b8-2.webp" alt=""
                             class="iphone__propicon round lazy js-slide-opac">
                        <div class="iphone__proptitle">Занятия в мини-группах</div>
                        <p>Под руководством действующих нутрициологов, которые ответят на все вопросы, напомнят о
                            занятиях и помогут правильно проконсультировать первых<br> клиентов</p>
                    </div>
                    <div class="iphone__prop">
                        <div class="iphone__propicon iphone__counter jbm flexi">700+</div>
                        <div class="iphone__proptitle">Часов обучения</div>
                        <p>Комплексный и системный подход к здоровью по западной методологии: 200+ видеолекций, 300+
                            часов семинарских и практических занятий</p>
                    </div>
                    <div class="iphone__prop">
                        ...
                        <p>Более 10 звезд индустрии: доктора наук, профессоры университетов, лидеры мнений, врачи,
                            практикующие специалисты</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="nutri9">
        <div class="container flexi">
            ...
            <div class="nutri9__block">
                ...
                <div class="nutri9__line2">Федеральный исследовательский центр питания, <br>биотехнологий и безопасности
                    пищи
                </div>
    ...
    <section class="programfromlead mb-0  programfromlead--nutri2">
        ...
        <div class="container">
            ...
            <?php
            get_template_part('inc/leadform', null,
                ['buttonTxt' => 'Получить консультацию', 'formClassName' => 'nutriformbox']); ?>
        </div>
    </section><!-- //programfromlead -->
    ...
    <section class="programfromlead mb-0  programfromlead--nutri2">
        ...
        <div class="container">
            ...
            <?php
            get_template_part('inc/leadform', null,
                ['buttonTxt' => 'Задать вопрос', 'formClassName' => 'nutriformbox']); ?>
        </div>
    </section><!-- //programfromlead -->
        ...
        <div class="container">
            ...
            <div class="grid-mob-scroll">
                <div class="nutri15__grid">
                    <div class="nutri15__item js-slide-bot">
                        <div class="nutri15__picwrap"><img src="<?= $pics; ?>/b15-1.webp" alt="" class="nutri15__pic">
                        </div>
                    ...
                    <div class="nutri15__item js-slide-bot">
                        <div class="nutri15__picwrap"><img src="<?= $pics; ?>/b15-2.webp" alt="" class="nutri15__pic">
                        </div>
                    ...
                    <div class="nutri15__item js-slide-bot">
                        <div class="nutri15__picwrap"><img src="<?= $pics; ?>/b15-3.webp" alt="" class="nutri15__pic">
                        </div>
                    ...
                    <div class="nutri15__item js-slide-bot">
                        <div class="nutri15__picwrap"><img src="<?= $pics; ?>/b15-4.webp" alt="" class="nutri15__pic">
                        </div>
                        <div class="nutri15__title">Программа питания</div>
                        <div class="nutri15__txt">Готовый рацион для ваших клиентов, рассчитанный на неделю, месяц,
                            год
                        </div>
                    </div>
                </div>
            ...
            <div class="nutri15__bottom flexi">
                ...
                <aside class="nutri15__botpicwrap">
                    <img src="<?= $pics; ?>/b16-bot.png" alt="" class="nutri15__botpic js-slide-bot" width="664"
                         height="591">
                </aside>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="nutri18__item">
                            ...
                            <div class="nutri18__txt">Составите анкету и заполните её с клиентом. Проведёте анализ на
                                основе ответов на вопросы.
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="nutri18__item">
                            ...
                            <div class="nutri18__txt">Заполните с клиентом дневник питания и&nbsp;составите рацион на
                                день
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="nutri18__item">
                            ...
                            <div class="nutri18__txt">Проанализируете анализ крови клиента и&nbsp;его образ жизни,
                                дадите рекомендации по корректировке питания и составите рацион
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="nutri18__item">
                            ...
                            <div class="nutri18__txt">Заполните с клиентом психологический опросник и проанализируете
                                состояние клиента
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="nutri18__item">
                            ...
                            <div class="nutri18__txt">Определите потребность клиента в витаминах и минералах на основе
                                его анализов и скорректируете рацион
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="timeslot__box">
                ...
                <div class="timeslot__over flexi">
                    <div class="timeslot__text">
                        <p>С каждой группой <br>работает отдельный <br>куратор специалист <br>и&nbsp;привлечению
                            клиентов</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="nutri21__grid">
                <div class="nutri21__col">
                    ...
                    <p>Устроиться на работу в фитнес-<br>центр, клинику, государственное <br>или коммерческое учреждение
                    </p>
                </div>
                <div class="nutri21__col">
...
<?php
    ...
    <div class="nutri23">
        <div class="container diploma__container">
            <h2 class="diploma__header"><b class="diploma__nutri">Каждый выпускник</b> <br> курса получает</h2>
            <div class="diploma__block diploma__layout--grey">
                <div class="diploma__info"><p class="diploma__num diploma__black--back">01</p>
                    <h3 class="diploma__subheader diploma__nutri">Диплом о <br> профессиональной переподготовке <br>
                        <span
                                class="diploma__black">установленного <br> образца РФ</span></h3>
                    <div class="diploma__text diploma__black">Это официальный документ, <span class="diploma__grey">который <br> дает вам право осуществлять <br> профессиональную деятельность</span>
                    </div>
                </div>
                <div class="diploma__pic"><img
                            src="<?= imgs(); ?>/nutriciolog/dip-nut.jpg" alt="diploma" class="diploma__img"
                            width="540" height="380"></div>

            </div>
            <div class="diploma__block diploma__layout--black">
                <div class="diploma__info"><p class="diploma__nutri--back diploma__num ">02</p>
    ...
    <section class="nutri26">
        <div class="container">
            ...
            <div class="nutri26__sub">
                Ведь знания о правильном питании и ЗОЖ можно использовать <br>и для себя, и для близких и <b>дорогих
                    людей</b>
            </div>
            <div class="grid-mob-scroll">
        ...
        <div class="reviewsslider__wrap">
            ...
            <div class="reviewsslider__cont js-slide-bot">
                <div class="swiper">
                    <div class="swiper-wrapper">
                        <?php
                        foreach (range(1, 11, 1) as $key => $videoNum) : ?>
                            <div class="swiper-slide">
        ...
        <div class="faqblock__wrap container">
                ...
                <div class="progrmsummary__contentwrap" data-hidebox="faq4">
                    <div class="progrmsummary__content">
                        ...
                        <p>Если на момент окончания обучения у вас будет высшее или среднее профессиональное
                            ...
                            дипломе будет указана квалификация: «Интегративный нутрициолог».</p>
                        <p>Такой диплом дает право вести практическую деятельность.<br>
                            Каждый выпускник курса получает два международных диплома.<br>
                            Первый диплом <a
                                    href="https://www.iphm.co.uk/directory/find-an-accredited-training-provider/talentsy-1/"
                                    target="_blank">IPHM</a> и второй диплом <a href="https://cpduk.co.uk/"
                                                                                target="_blank">CPD</a></p>
                    </div>
                </div>
            </div><!-- //item -->
            ...
            <div class="progrmsummary__item" data-hidewrap="faq2">
                ...
                <div class="progrmsummary__contentwrap" data-hidebox="faq2">
                    <div class="progrmsummary__content">
                        <p>Да. Наша образовательная программа включает 300 часов практических занятий в мини-группах, во
