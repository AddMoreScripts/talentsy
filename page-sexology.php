      ...
      <div class="sex1__grid">
        <div class="sex1__item">
          <div class="sex1__imgwrap">
            <img src="<?= imgs(); ?>/sexolog/b2-1.png" alt="">
          </div>
        ...
        <div class="swiper-wrapper">
          <?php foreach (range(1, 7, 1) as $key => $videoNum) : ?>
            <div class="swiper-slide">
              <a href="<?= imgs(); ?>/sexolog/reviews/<?= str_pad($videoNum, 3, '0', STR_PAD_LEFT); ?>-full.mp4" class="reviewsslider__videowrap square" data-ratio="0.5625" data-fancybox="reviewVideo">
                <video loop muted playsinline preload="auto" controlslist="nodownload" disablepictureinpicture="" crossorigin="anonymous" class="reviewsslider__screen square__img lazy">
                  <source data-src="<?= imgs(); ?>/sexolog/reviews/<?= str_pad($videoNum, 3, '0', STR_PAD_LEFT); ?>.mp4">
                </video>
...
<section class="psy8">
  <div class="container">
    ...
    <img data-src="<?= imgs(); ?>/sexolog/b8-bg.png" alt="" class="psy8__bg lazy" style="aspect-ratio: 1680 / 739;">
    ...
    <div class="teamblock flexi">
      ...
      <div class="swiper teamslider js-team-slider">
        <div class="swiper-wrapper">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/alexandrova.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/oganezov.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/saaryan.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/shegoleva.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/rukoleeva.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/litvinova.jpg" alt="" class="teamslider__photo">
          ...
          <article class="swiper-slide teamslider__slide">
            <div class="teamslider__item">
              <img src="<?= imgs(); ?>/mentors/ogorodnikova.jpg" alt="" class="teamslider__photo">
...
<section class="stepform sex11">
  <div class="container">
    ...
    <?php get_template_part('inc/leadform', null, ['formClassName' => 'programfromlead__formwrap--red']); ?>
  </div>
</section><!-- //stepform -->
...
<section class="diplomblock diplomblock--sex">
  <div class="container">
    ...
    <div class="swiper js-diplomblock-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="<?= imgs(); ?>/sexolog/b17-diplom.jpg" alt="" class="diplomblock__sl-pic">
        </div>
        <div class="swiper-slide">
          <img src="<?= imgs(); ?>/sexolog/b17-diplom2.jpg" alt="" class="diplomblock__sl-pic">
        </div>
      </div>
      <button class="ctrl ctrl--prev"><img src="<?= imgs(); ?>/ui/slider-ctrl.svg" alt=""></button>
      <button class="ctrl ctrl--next"><img src="<?= imgs(); ?>/ui/slider-ctrl.svg" alt=""></button>
