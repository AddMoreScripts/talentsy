...
<section class="mentors mentors--astro" style="background-image: url(<?=$pics; ?>/b9-bg.webp);">
  <div class="container">
    ...
    <?php include(locate_template('inc/_astrolog_mentors_data.php')); ?>
          ...
          <?php foreach ($mentorsLeft as $key => $mentor) : ?>
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                ...
                <img src="<?= imgs(); ?>/astrolog/mentors/<?= $mentor['img']; ?>" alt="" class="teamslider__photo" loading="lazy">
...
<section class="priceblock priceblock--astro mb-0" id="offer">
  <div class="container">
    ...
    <div class="priceblock__greenprice jbm js-slide-bot"><span>От</span> <span>5000</span> <span>₽/МЕС</span> <small>Скидка 40% <b>до
