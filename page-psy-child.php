...
<section class="hero hero--kids">
    <div class="hero__h1 jbm">
      За 1,5 года <img src="<?=imgs(); ?>/psychology-kid/b1-sm.webp" alt="" class="hero-mob-img"><div></div>поможем <img src="<?=imgs(); ?>/psychology-kid/b1-sm.webp" alt=""> вам стать <br>
      <b>успешным детским психологом-<br>
  ...
  <section class="mentors">
    <div class="container">
      <h2 class="title">вы будете учиться <span>у&nbsp;</span><b>16 ТОП-<br class="mobbr">специалистов</b> <span>со
          всей страны</span></h2>
  ...
  <section class="diplomblock">
      <div class="container diploma__container">
          <h2 class="diploma__header"><b class="diploma__child">Каждый выпускник</b> <br> курса получает</h2>
          <div class="diploma__block diploma__layout--grey">
              <div class="diploma__info"><p class="diploma__num diploma__black--back">01</p>
                  <h3 class="diploma__subheader diploma__child">Диплом о <br> профессиональной переподготовке <br>
                      <span
              ...
              <div class="diploma__pic"><img
                          src="<?= imgs(); ?>/psychology-kid/dip-kid.jpg" alt="diploma" class="diploma__img"
                          width="540" height="380"></div>

          </div>
          <div class="diploma__block diploma__layout--black">
              <div class="diploma__info"><p class="diploma__child--back diploma__num ">02</p>
  ...
  <section class="priceblock" id="offer">
    <div class="container">
      ...
      <div class="priceblock__greenprice jbm">
        <span>От</span> <span class="jsPPSumm">10000</span> <span>₽/МЕС</span>
