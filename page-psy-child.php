<?php
/*
Template name: Шаблон: Профессия детский психолог
*/
get_header();
?>
...
<section class="hero hero--kids">
    ...
    <div class="hero__videowrap ">
      <div class="hero__videobox square">
        <video class="hero__video square__img" preload="auto" playsinline="" autoplay="" loop="" muted="">
          <source src="<?=imgs(); ?>/psychology-kid/b1-video.mp4">
        </video>
      </div>
      ...
      <div class="iphone__wrap flexi">
        ...
        <div class="iphone__grid">
          ...
          <div class="iphone__prop">
            ...
            <p>1700 академических часов, 300&nbsp;видеолекций, 550 часов семинарских и практических занятий за 85
              недель обучения</p>
          </div>
          <div class="iphone__prop">
            <img data-src="<?=imgs(); ?>/psychology-kid/b2-4.webp" alt="" class="iphone__propicon lazy js-slide-opac">
        ...
        <div class="dreams__grid">
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img data-src="<?=imgs(); ?>/psychology-kid/b4-1.webp" alt="" class="lazy js-slide-opac">
            </div>
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img data-src="<?=imgs(); ?>/psychology-kid/b4-2.webp" alt="" class="lazy js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item dreams__item--bg">
            <div class="dreams__iconwrap">
              <img data-src="<?=imgs(); ?>/psychology-kid/b4-3.webp" alt="" class="lazy">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item  dreams__item--light">
            <div class="dreams__iconwrap">
              <img data-src="<?=imgs(); ?>/psychology-kid/b4-4-1.svg" alt="" class="lazy js-slide-opac">
  ...
  <section class="psy6">
    <div class="container">
      <h2 class="title">
        <b>Более 60% родителей</b><br>
        считают, что им требуется<br>
      ...
      <div class="psy6__wrap">
        <div class="psy6__item js-slide-interval">
          ...
          <div class="psy6__text">
            По данным ТАСС в 2021 году спрос на детских психологов в России <b>вырос на 153%</b>
          </div>
        </div>
        <div class="psy6__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology/b6-2.svg" alt="" class="psy6__icon">
          <div class="psy6__text">
            Детский психолог - одна из немногих профессий, спрос на которую в любые сложные времена <b>только растет</b>
          </div>
        </div>
        <div class="psy6__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology/b6-3.png" alt="" class="psy6__icon">
          <div class="psy6__text">
            По данным hh <b>1479 компаний</b> ищут детского психолога прямо сейчас
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="kidgrid">
    <div class="container">
      <h2 class="title">
        Где можно работать по <br>
    ...
    <div class="container">
      ...
      <div class="psy7__wrap">
        <div class="psy7__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology-kid/b8-1.svg" alt="" class="psy7__icon">
        ...
        <div class="psy7__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology-kid/b8-2.svg" alt="" class="psy7__icon">
        ...
        <div class="psy7__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology-kid/b8-3.svg" alt="" class="psy7__icon">
          <div class="psy7__title">Для тех, кто хочет освоить детскую психологию для себя</div>
          <div class="psy7__text">
            Научитесь понимать и принимать своего ребёнка. Поймёте причины плохого поведения детей. Научитесь выстраивать доверительные отношения и избежите лишней ругани и криков.
          </div>
        </div>
        <div class="psy7__item js-slide-interval">
          <img src="<?=imgs(); ?>/psychology-kid/b8-4.svg" alt="" class="psy7__icon">
          <div class="psy7__title">Для тех, кому нужен диплом для работы</div>
          <div class="psy7__text">
            Если вы уже работаете психологом, педагогом дошкольных и школьных учреждений, детских развивающих центров и хотите получить новую специализацию. (А так же два международных сертификата с правом консультирования в сфере психологии)
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="psy8 psy8--kids">
    <div class="container">
      <h2 class="title">Мы готовим квалифицированных <br><b>детских психологов-консультантов</b></h2>
  ...
  <section class="mentors">
    <div class="container">
      <h2 class="title">вы будете учиться <span>у&nbsp;</span><b>16 лучших <br class="mobbr">специалистов</b> <span>со
          всей страны</span></h2>
      ...
      <div class="teamblock flexi">
        <div class="teamblock__nav jbm teamblock__nav--left">
          ...
          <a href="#" class="teamblock__navlink" data-slide="7">Малафеева</a>
        </div>
        <div class="teamblock__nav jbm teamblock__nav--right">
          <a href="#" class="teamblock__navlink" data-slide="8">Николаева</a>
          <a href="#" class="teamblock__navlink" data-slide="9">Фомичева</a>
          <a href="#" class="teamblock__navlink" data-slide="10">Долгушин</a>
          <a href="#" class="teamblock__navlink" data-slide="11">Двойнин</a>
          <a href="#" class="teamblock__navlink" data-slide="12">Киселёв</a>
          <a href="#" class="teamblock__navlink" data-slide="13">Меглинская</a>
          <a href="#" class="teamblock__navlink" data-slide="14">Томина</a>
        </div>
        ...
        <div class="swiper teamslider js-team-slider">
          <div class="swiper-wrapper">
            ...
            <article class="swiper-slide teamslider__slide">
              <div class="teamslider__item">
                <img src="<?=imgs(); ?>/mentors/malafeeva.jpg" alt="" class="teamslider__photo">
                ...
                <div class="teamslider__content">
                  <ul>
                    ...
                    <li>С 2001 года занимается нейропсихологической коррекцией детей разных возрастов, ведет практикум по детской нейропсихологии и читает курс лекций по психологии аномального развития </li>
                  </ul>
                </div>
              </div>
            </article>
        ...
        <div class="features__right">
          ...
          <div class="features__grid">
            ...
            <div class="features__item">
              ...
              <p>Более <b> 1000 дополнительных материалов </b>, (примеры, шаблоны, схемы)</p>
            </div>
          </div>
  ...
  <section class="progrmsummary container">
    ...
    <div class="progrmsummary__wrap">
      ...
      <?php get_template_part('inc/kids-program'); ?>
  ...
  <section class="diplomblock">
    <div class="container">
      ...
      <div class="swiper js-diplomblock-slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="<?=imgs(); ?>/psychology-kid/diplom-1.webp" alt="" class="diplomblock__sl-pic">
          </div>
          <div class="swiper-slide">
            <img src="<?=imgs(); ?>/psychology-kid/diplom-2.webp" alt="" class="diplomblock__sl-pic">
          </div>
        </div>
        <button class="ctrl ctrl--prev"><img src="<?=imgs(); ?>/ui/slider-ctrl.svg" alt=""></button>
        <button class="ctrl ctrl--next"><img src="<?=imgs(); ?>/ui/slider-ctrl.svg" alt=""></button>
    ...
    <div class="container">
      ...
      <div class="grid-mob-scroll">
        <div class="dreams__grid">
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-1.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
              Без конфликтов договариваться со&nbsp;своим ребенком и находить общий язык
            </div>
          </div>
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img src="<?=imgs(); ?>/psychology-kid/b22-2.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item dreams__item--bg">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-3.webp" alt="">
            </div>
            <div class="dreamsltitle dreamsltitle--gray">
              Помогать ребенку преодолеть кризисы взросления и сложности в&nbsp;саду или со сверстниками
            </div>
          </div>
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-4.svg" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
              Справиться с родительским выгоранием
            </div>
          </div>
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-5.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
          ...
          <div class="dreams__item">
            <div class="dreams__iconwrap dreams__iconwrap--wide">
              <img src="<?=imgs(); ?>/psychology-kid/b22-6.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
              Помогать родителям справиться с&nbsp;трудностями в&nbsp;воспитании детей
            </div>
          </div>
          <div class="dreams__item">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-7.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
              Самостоятельно разрабатывать и&nbsp;проводить коррекционно-развивающие программы для детей
            </div>
          </div>
          <div class="dreams__item dreams__item--border">
            <div class="dreams__iconwrap">
              <img src="<?=imgs(); ?>/psychology-kid/b22-8.webp" alt="" class="js-slide-opac">
            </div>
            <div class="dreamsltitle">
              Повысить квалификацию <br>и&nbsp;расширить спектр своих услуг
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="faqblock__wrap container">
      ...
      <div class="progrmsummary__item" data-hidewrap="faq19">
        <div class="progrmsummary__head" data-hideopen="faq19">
          <strong>Дистанционное обучение не помеха для повышения квалификации?</strong>
          <button class="progrmsummary__plus">+</button>
        </div>
        <div class="progrmsummary__contentwrap" data-hidebox="faq19">
          <div class="progrmsummary__content">
            <p>Пандемия коронавируса внесла свои коррективы в жизнь людей, поэтому сегодня можно большинство профессий получить в режиме онлайн. </p>
            <p>Это же касается и психологии детей и подростков. Вас обучают опытные наставники, у вас есть как теоретические, так и практические задания. Вы сможете получить новые знания, если вы этого хотите. </p>
            <p>Дистанционное обучение довольно удобно и практично. Вы можете проходить программу курса в комфортных для себя условиях. Наши преподаватели уверены, что даже в дистанционном формате у вас получится освоить профессию.</p>
          </div>
        </div>
      </div><!-- //item -->
      ...
      <div class="progrmsummary__item" data-hidewrap="faq20">
        <div class="progrmsummary__head" data-hideopen="faq20">
          <strong>Курсы могут выступать в качестве дополнительного образования?</strong>
          <button class="progrmsummary__plus">+</button>
        </div>
        <div class="progrmsummary__contentwrap" data-hidebox="faq20">
          <div class="progrmsummary__content textcontent">
            <p>Да, для того чтобы прийти к нам на курсы, можно быть как психологом (иметь психолого-педагогическое образование), так и иметь другую профессию, а также большое желание переквалифицироваться. </p>
            <p>Наши преподаватели дают информацию доступно и понятно. Поэтому даже если вы не посещали институт, вам будет легко обучаться.</p>
          </div>
        </div>
      </div><!-- //item -->
      ...
      <div class="progrmsummary__item" data-hidewrap="faq21">
        <div class="progrmsummary__head" data-hideopen="faq21">
          <strong>После прохождения курса можно оказывать помощь детям и подросткам?</strong>
          <button class="progrmsummary__plus">+</button>
        </div>
        <div class="progrmsummary__contentwrap" data-hidebox="faq21">
          <div class="progrmsummary__content textcontent">
            <p>После курсов вы можете работать с детьми и подростками в удобном для вас формате.</p>
            <p>Обучение проходит полностью дистанционно. Поэтому вы можете обучаться в удобное для вас время в дистанционном формате.</p>
          </div>
        </div>
      </div><!-- //item -->
  ...
  <section class="talentsyabout">
    <div class="container">
      ...
      <div class="talentsyabout__tags" data-hidewrap="tags">
        <a href="#" class="talentsyabout__tag">Курс Детская <br>психология</a>
        <a href="#" class="talentsyabout__tag">Семейная <br>психология</a>
        <a href="" class="talentsyabout__tag">Детская и подростковая <br>психотерапия</a>
        <a href="" class="talentsyabout__tag">Детская <br>практическая <br>психология</a>
        <a href="" class="talentsyabout__tag">Практическая <br>психологическая <br>помощь</a>

        <div data-hidebox="tags" class="talentsyabout__more">
          <a href="" class="talentsyabout__tag">Клиническая психология детей</a>
          <a href="" class="talentsyabout__tag">Особенности консультирования <br>детей</a>
          <a href="" class="talentsyabout__tag">Практический <br>психолог</a>
          <a href="" class="talentsyabout__tag">Семинары и <br>тренинги на курсе</a>
          <a href="" class="talentsyabout__tag">Курс детской <br>психотерапии</a>
          <a href="" class="talentsyabout__tag">Курс Детский психолог</a>
          <a href="" class="talentsyabout__tag">Особенности психологической <br>работы с детьми и подростками</a>
          <a href="" class="talentsyabout__tag">Курс повышения <br>квалификации дистанционно</a>

          <a href="" class="talentsyabout__tag">Дошкольная педагогика</a>
          <a href="" class="talentsyabout__tag">Психологическое <br>сопровождение ребенка</a>
          <a href="" class="talentsyabout__tag">Дистанционное <br>обучение <br>психологии</a>
          <a href="" class="talentsyabout__tag">Программа образовательного <br>курса по детской психологии</a>
          <a href="" class="talentsyabout__tag">Курс консультативной <br>психологии</a>
          <a href="" class="talentsyabout__tag">Программа профессиональной <br>переподготовки</a>
          <a href="" class="talentsyabout__tag">Психологическое <br>консультирование детей</a>
        </div>
      </div>
